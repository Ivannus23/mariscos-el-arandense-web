...
const charolas = [
  ...
  },
  {
    ...
    description: "Listos para compartir en cualquier reunión.",
    price: "$100 USD",
  ...
  },
  {
    ...
    description:
      "Especialidad de la casa con gran sabor y excelente porción. Incluye arroz blanco y ensalada.",
    price: "$100 USD",
  ...
  },
  {
    ...
    description:
      "Charola especial con gran sabor y excelente porción. Incluye arroz y ensalada.",
    price: "$120 USD",
  ...
  },
  {
    ...
    description:
      "Mezcla fresca de camarón y pulpo, ideal para disfrutar al momento.",
    price: "$25 USD",
    ...
    <main className="min-h-screen bg-[#fff7ed]">
      ...
      <section id="menu" className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        ...
        <div className="mt-16">
          <MenuSection
            id="individuales"
            title="Porciones individuales"
            subtitle="Para cuando el antojo llega con nombre y apellido."
            items={individuales}
        ...
        <footer className="pb-8 pt-10 text-center">
          <p className="text-sm font-medium text-slate-500">
            © {new Date().getFullYear()} Mariscos El Arandense. Todos los
            derechos reservados.
          </p>
        </footer>
      </section>
